...
pub fn TreeSelectDemo() -> Element {
    ...
    div { style: "display: flex; flex-direction: column; gap: 16px;",
        TreeSelect { class: "tree-select-large", style: "width: 300px; height: 40px;", placeholder: "大尺寸" }
        TreeSelect { class: "tree-select-default", style: "width: 300px; height: 32px;", placeholder: "默认尺寸" }
        TreeSelect { class: "tree-select-small", style: "width: 300px; height: 24px;", placeholder: "小尺寸" }
    }
}"#,
                demo: rsx! {
                    div { style: "display: flex; flex-direction: column; gap: 16px;",
    ...
    TreeSelect {
        ...
        style: "width: 300px; border: 2px solid #1677ff; border-radius: 8px;",
        placeholder: "自定义样式"
    }
}"#,
                demo: rsx! {
