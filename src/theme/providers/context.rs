...
/// 主题 Hook 的返回类型
pub struct UseTheme {
    pub(crate) context: Signal<ThemeContext>,
}

impl UseTheme {
    /// 创建新的 UseTheme 实例
    pub fn new(context: Signal<ThemeContext>) -> Self {
        Self { context }
    }
...
pub struct UseResponsiveTheme {
    pub(crate) theme: UseTheme,
}

impl UseResponsiveTheme {
    /// 创建新的 UseResponsiveTheme 实例
    pub fn new(theme: UseTheme) -> Self {
        Self { theme }
    }
