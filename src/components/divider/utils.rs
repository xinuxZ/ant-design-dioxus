...
pub fn generate_css_variables(theme: &DividerTheme) -> HashMap<String, String> {
    ...
    variables.insert("--divider-color-split".to_string(), theme.color_split.clone());
    variables.insert("--divider-color-text".to_string(), theme.color_text.clone());
    variables.insert("--divider-color-text-secondary".to_string(), theme.color_text_secondary.clone());
    variables.insert("--divider-font-size".to_string(), theme.font_size.clone());
    variables.insert("--divider-font-size-sm".to_string(), theme.font_size_sm.clone());
    variables.insert("--divider-font-size-lg".to_string(), theme.font_size_lg.clone());
    variables.insert("--divider-line-height".to_string(), theme.line_height.clone());
    ...
    variables.insert("--divider-text-padding".to_string(), theme.text_padding.clone());
    variables.insert("--divider-vertical-height".to_string(), theme.vertical_height.clone());
    variables.insert("--divider-vertical-margin".to_string(), theme.vertical_margin.clone());
    variables.insert("--divider-border-width".to_string(), theme.border_width.clone());
...
pub fn generate_divider_style(
    ...
    // 自定义样式
    if let Some(ref custom_style) = config.style {
...
pub fn generate_text_style(
    ...
    // 内边距
    let padding = calculate_text_margin(&config.orientation, config.orientation_margin.as_ref(), &config.size);
