...
use super::types::{CommonIconType, IconTheme};
...
/// 常用图标的SVG数据
pub fn get_common_icon_svg(icon_type: &CommonIconType) -> Option<SvgIcon> {
    match icon_type {
        CommonIconType::Success => Some(SvgIcon {
        ...
        CommonIconType::Warning => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Error => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
            path: "M512 64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64zm165.4 618.2l-66-.3L512 563.4l-99.3 118.4-66.1.3c-4.4 0-8-3.5-8-8 0-1.9.7-3.7 1.9-5.2l130.1-155L340.5 359a8.32 8.32 0 0 1-1.9-5.2c0-4.4 3.6-8 8-8l66.1.3L512 464.6l99.3-118.4 66-.3c4.4 0 8 3.5 8 8 0 1.9-.7 3.7-1.9 5.2L553.5 514l130 155c1.2 1.5 1.9 3.3 1.9 5.2 0 4.4-3.6 8-8 8z".to_string(),
            width: None,
            height: None,
        ...
        CommonIconType::Home => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::User => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Setting => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Search => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Close => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Check => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Plus => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Delete => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Download => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Upload => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Loading => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::ArrowDown => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::ArrowUp => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::ArrowLeft => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::ArrowRight => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
            path: "M869 487.8L491.2 159.9c-2.9-2.5-6.6-3.9-10.5-3.9h-88.5c-7.4 0-10.8 9.2-5.2 14l350.2 304H152c-4.4 0-8 3.6-8 8v60c0 4.4 3.6 8 8 8h585.1L386.9 854c-5.6 4.9-2.2 14 5.2 14h91.5c1.9 0 3.8-.7 5.2-2L869 536.2a31.96 31.96 0 0 0 0-48.4z".to_string(),
            width: None,
            height: None,
        }),
        CommonIconType::CaretDown => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::CaretUp => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::CaretLeft => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::CaretRight => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Question => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Info => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Exclamation => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Copy => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Save => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Menu => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::More => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
        ...
        CommonIconType::Custom(data) => Some(SvgIcon {
            view_box: "0 0 1024 1024".to_string(),
            path: data.to_string(),
            width: None,
            height: None,
