...
mod tests {
    ...
    use crate::config_provider::{
        ButtonConfig, ComponentConfig, ComponentSize, ConfigBuilder, ConfigError, ConfigManager,
        ConfigMerge, ConfigProviderBuilder, ConfigSnapshot, ConfigValidate, CspConfig, Direction,
        FormConfig, InputConfig, MergeStrategy, NonceGenerator, PopupConfig, PopupManager,
        PopupPlacement, PresetConfigBuilder, SecurityConfig, StyleSecurityValidator, TableConfig,
        VirtualScrollConfig, VirtualScrollDirection, VirtualScrollManager,
    };
    ...
    fn test_virtual_scroll_config() {
        ...
        assert_eq!(
            vs_config.scroll_config.direction,
            VirtualScrollDirection::Horizontal
        );
    ...
    fn test_config_merge() {
        ...
        let merged = base_config
            .merge(&override_config, &MergeStrategy::DeepMerge)
            .unwrap();
    ...
    fn test_config_manager() {
        ...
        manager.add_source(
            "test",
            config_value.clone(),
            crate::config_provider::config_utils::ConfigPriority::Normal,
        );
    ...
    fn test_config_diff() {
        ...
        let diff = crate::config_provider::config_utils::utils::compare_configs(&config1, &config2)
            .unwrap();
    ...
    fn test_config_flatten_unflatten() {
        ...
        // 扁平化
        let flattened =
            crate::config_provider::config_utils::utils::flatten_config(&config).unwrap();
        ...
        // 反扁平化
        let unflattened: ComponentConfig =
            crate::config_provider::config_utils::utils::unflatten_config(&flattened).unwrap();
